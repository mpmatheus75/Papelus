...
const DADOS_INICIAIS = {
  produtos: [
    ...
    { id: 3, nome: 'Caderno Inteligente Mini Grey Love', categoria: 'Caderno', preco: 69.90, custo: 39.90, quantidade: 1, minimo: 1 },
  ],
  vendas: [],
  proximoId: 4
}
...
function carregarDados() {
  try {
    const salvo = localStorage.getItem('papelus_dados')
...
export function useEstoque() {
  ...
  return { dados, adicionarProduto, deletarProduto, registrarVenda, editarProduto }
}